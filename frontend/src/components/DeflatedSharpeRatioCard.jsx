                ...
                <div className={`p-4 rounded-2xl border transition relative overflow-hidden flex flex-col justify-between ${
                    ...
                    <div className="my-3 flex items-baseline gap-2">
                        <span className={`text-3xl font-extrabold font-mono tracking-tight ${
                            isSignificant ? 'text-emerald-400' : riskLevel === 'MODERATE' ? 'text-amber-400' : 'text-rose-400'
                        }`}>
                        ...
                        <div className="w-full bg-gray-900 rounded-full h-2 overflow-hidden border border-gray-700/60 relative">
                            <div
                                className={`h-full rounded-full transition-all duration-500 ${
                                    isSignificant ? 'bg-emerald-500' : riskLevel === 'MODERATE' ? 'bg-amber-500' : 'bg-rose-500'
                                }`}
